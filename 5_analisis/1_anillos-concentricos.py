...
CONFIGURACION: Dict[str, Any] = {
    ...
    "directorio_salida": Path('/home/tdelorenzi/1_yolo/1_segregacion/6_resultados/2025-08-04'),
    "informacion_clases": {
...
class AnalizadorSegregacion:
    ...
    def __init__(self, configuracion: Dict[str, Any]):
        ...
        self.ruta_video_salida = self.configuracion["directorio_salida"] / '08-07-2025-segregacion1.mp4'
    ...
    def _dibujar_anotaciones(self, frame: np.ndarray, detecciones: List[Dict], si_actual: float, conteos: np.ndarray):
        ...
        for det in detecciones:
            ...
            cv2.circle(frame, centro_p, 3, color, -1)  # Punto sólido de radio 3
    ...
    def procesar_frame(self, frame: np.ndarray) -> np.ndarray:
        ...
        # Cálculo de métricas del frame (sin cambios en la lógica)
    ...
    def guardar_resultados(self):
        ...
        # Guardar CSV
        ruta_csv = self.configuracion["directorio_salida"] / '08-07-2025-segregation_data.csv'
        ...
        plt.legend()
        plt.savefig(self.configuracion["directorio_salida"] / '08-07-2025_si_evolution.png')
        plt.close()
        ...
        plt.xlabel('Región (1=centro, 9=borde)')
        plt.ylabel('Fracción promedio de "no-convexa1"')
        plt.title('Distribución Radial Promedio de Partículas')
        plt.xticks(range(1, self.num_regiones + 1))
        plt.legend()
        plt.savefig(self.configuracion["directorio_salida"] / '08-07-2025_radial_distribution.png')
        plt.close()
